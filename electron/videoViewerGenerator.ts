// Generates a self-contained HTML page for viewing a deployed deck VIDEO as slides.
// Video-only player (no JPG overlay → no color-space/resolution mismatch):
...
// See docs/VIDEO_DECK_VIEWER.md. Supersedes the GIF path for held-build /
// constant-background decks (progressive GIF compositing ghosts).
...
<body>
  ...
  <div id="deckContainer"><div id="deck"><video id="vid" muted playsinline preload="auto" src="./${videoFilename}"></video></div></div>
  <div id="viewer">
