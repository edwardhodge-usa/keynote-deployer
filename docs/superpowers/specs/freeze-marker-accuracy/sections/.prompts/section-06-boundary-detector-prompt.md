...
Generate content for section `section-06-boundary-detector` (filename: `section-06-boundary-detector.md`).
...
for `section-06-boundary-detector` to understand what this section should contain.
...
`/Users/EdwardHodge_1/Code/keynote-deployer/docs/superpowers/specs/freeze-marker-accuracy/sections/section-06-boundary-detector.md`
