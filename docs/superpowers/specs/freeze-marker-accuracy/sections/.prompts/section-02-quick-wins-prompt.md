...
Generate content for section `section-02-quick-wins` (filename: `section-02-quick-wins.md`).
...
for `section-02-quick-wins` to understand what this section should contain.
...
`/Users/EdwardHodge_1/Code/keynote-deployer/docs/superpowers/specs/freeze-marker-accuracy/sections/section-02-quick-wins.md`
