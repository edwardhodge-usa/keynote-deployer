...
Generate content for section `section-05-rest-selector` (filename: `section-05-rest-selector.md`).
...
for `section-05-rest-selector` to understand what this section should contain.
...
`/Users/EdwardHodge_1/Code/keynote-deployer/docs/superpowers/specs/freeze-marker-accuracy/sections/section-05-rest-selector.md`
