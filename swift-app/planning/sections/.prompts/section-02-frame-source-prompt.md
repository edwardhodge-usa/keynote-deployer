...
Generate content for section `section-02-frame-source` (filename: `section-02-frame-source.md`).
...
for `section-02-frame-source` to understand what this section should contain.
...
`/Users/EdwardHodge_1/Code/keynote-deployer/swift-app/planning/sections/section-02-frame-source.md`
