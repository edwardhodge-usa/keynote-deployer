...
Generate content for section `section-04-slide-detector` (filename: `section-04-slide-detector.md`).
...
for `section-04-slide-detector` to understand what this section should contain.
...
`/Users/EdwardHodge_1/Code/keynote-deployer/swift-app/planning/sections/section-04-slide-detector.md`
