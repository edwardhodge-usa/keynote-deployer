...
Generate content for section `section-01-models-project` (filename: `section-01-models-project.md`).
...
for `section-01-models-project` to understand what this section should contain.
...
`/Users/EdwardHodge_1/Code/keynote-deployer/swift-app/planning/specs/swift-video-parity/sections/section-01-models-project.md`
