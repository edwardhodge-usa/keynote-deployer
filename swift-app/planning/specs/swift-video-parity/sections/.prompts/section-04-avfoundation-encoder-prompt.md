...
Generate content for section `section-04-avfoundation-encoder` (filename: `section-04-avfoundation-encoder.md`).
...
for `section-04-avfoundation-encoder` to understand what this section should contain.
...
`/Users/EdwardHodge_1/Code/keynote-deployer/swift-app/planning/specs/swift-video-parity/sections/section-04-avfoundation-encoder.md`
