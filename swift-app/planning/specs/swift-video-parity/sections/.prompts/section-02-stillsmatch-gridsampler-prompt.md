...
Generate content for section `section-02-stillsmatch-gridsampler` (filename: `section-02-stillsmatch-gridsampler.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/EdwardHodge_1/Code/keynote-deployer/swift-app/planning/specs/swift-video-parity/claude-plan.md` - Full implementation plan
2. `/Users/EdwardHodge_1/Code/keynote-deployer/swift-app/planning/specs/swift-video-parity/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/EdwardHodge_1/Code/keynote-deployer/swift-app/planning/specs/swift-video-parity/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-02-stillsmatch-gridsampler` to understand what this section should contain.
...
`/Users/EdwardHodge_1/Code/keynote-deployer/swift-app/planning/specs/swift-video-parity/sections/section-02-stillsmatch-gridsampler.md`
