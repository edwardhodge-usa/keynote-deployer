...
Generate content for section `section-03-viewer-generator` (filename: `section-03-viewer-generator.md`).
...
for `section-03-viewer-generator` to understand what this section should contain.
...
`/Users/EdwardHodge_1/Code/keynote-deployer/swift-app/planning/specs/swift-video-parity/sections/section-03-viewer-generator.md`
